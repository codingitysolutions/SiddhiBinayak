        ...
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <div className="footer-social">
              ...
              <a href="https://www.instagram.com/siddhibinayakcatering/?hl=en" target="_blank" rel="noopener noreferrer" className="social-btn">
          ...
          <div className="footer-contact-col">
            ...
            <div className="footer-contact-item" style={{ alignItems: 'flex-start' }}>
              ...
              <span>Infront Of Z - Zone Apartment, Patia,<br/>Bhubaneswar, Odisha 751024</span>
            </div>
          </div>
